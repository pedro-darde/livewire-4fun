...
<template>
    <v-row>
        ...
        <v-col cols="3">
            <v-text-field label="Url" v-model="screen.url" variant="solo-filled" prepend-inner-icon="mdi-link"
                          :rules="rules.url"/>
        </v-col>
        <v-col cols="3">
            <v-text-field label="Table" v-model="screen.table" variant="solo-filled" prepend-inner-icon="mdi-table"
                          :rules="rules.table"/>
        </v-col>
    </v-row>
    <v-row>
        ...
        <v-col cols="4">
            <v-text-field label="Primary Key" v-model="screen.pk_name" variant="solo-filled"
                          prepend-inner-icon="mdi-key" :rules="rules.pk_name"/>
        </v-col>
    </v-row>
    <v-row>
        <v-col cols="12">
