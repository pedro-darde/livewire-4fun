...
const rules = (field) => {
  return {
    ...
    placeholder: [
      v => (field.config.type === "select" && !field.config.useAjaxToLoadOptions)  && !!v || 'Placeholder is required',
    ],
    options: [
              ...
              <v-row align="center" justify="center">
                <v-col cols="10">
                  ...
                  <v-row >
                    ...
                    <v-col cols="4">
                      <v-select  variant="solo-filled" label="Type" v-model="field.config.type" :items="fieldTypeOptions" :rules="rules(field).type"/>
                    </v-col>
                  </v-row>
                  <v-row v-if="hasToShowOptionsForSelect(field)">
                    ...
                    <v-col cols="4">
                      <v-text-field
                          :disabled="!field.config.useAjaxToLoadOptions"
                          label="Url to search for options"
                  ...
                  <v-row>
                    ...
                    <v-col cols="4">
                      <v-text-field  variant="solo-filled"
                                     ...
                                     hint="The placeholder of the field" persistent-hint :rules="rules(field).placeholder" />
                    </v-col>
                    <v-col cols="4">
                      <v-text-field  variant="solo-filled"
                                     label="Mask" v-model="field.config.mask"
                                     hint="The mask of the field, follow this template (##.###.###-##)" persistent-hint />
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col cols="3">
                      <v-text-field  variant="solo-filled"
                                     ...
                                     hint="The default value of the field" persistent-hint :rules="rules(field).default"/>
                    </v-col>
                    <v-col cols="3">
                      <v-autocomplete
                ...
                <v-col cols="2">
                  ...
                  <v-btn text="Remove" @click="removeField(index)" v-if="canShowRemove(field)"></v-btn>
                </v-col>
              </v-row>
            </v-container>
          </v-expansion-panel-text>
